...
<body style="height:400px;">
	<!--模拟窗口 查看报销单		data-toggle="modal"  data-target="#myModal2"-->
				...
				<table width="100%" border="1" cellspacing="0" cellpadding="0" class="addform-base">
					...
					<tbody>
						<tr class="cn_tr">
							...
							<td>填&nbsp;写&nbsp;人：</td><td class="cn_td">${reimburse.employeename }</td>
					...
					<tbody>
						<c:forEach items="${detaillist }" var="detail">
							<tr>
								...
								<td><img class="img" src="/jboa/images/${detail.pictruename }"></td>
							</tr>
						</c:forEach>
