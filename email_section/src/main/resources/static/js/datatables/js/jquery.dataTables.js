...
function(e, a, t) { !
	function(e) {
		...
		function s(e) {
			...
			function(n) {
				a = n.match(/^([^A-Z]+?)([A-Z])/),
				a && -1 !== o.indexOf(a[1] + " ") && (t = n.replace(a[0], a[2].toLowerCase()), l[t] = n, "o" === a[1] && s(e[n]))
			}),
			e._hungaianMap = l
		}
		function o(e, a, s) {
			if (e._hungaianMap) {
				...
				function(n) {
					l = e._hungaianMap[n],
					l === t || !s && a[l] !== t || (a[l] = a[n], "o" === l.charAt(0) && o(e[l], a[n]))
				})
			}
		}
		function l(e) {
			var a = Ra.defaults.oLanguage; ! e.sEmptyTable && e.sZeroRecords && "No data available in table" === a.sEmptyTable && wa(e, e, "sZeroRecords", "sEmptyTable"),
			!e.sLoadingRecords && e.sZeroRecords && "Loading..." === a.sLoadingRecords && wa(e, e, "sZeroRecords", "sLoadingRecords")
		}
		function r(e, s) {
			...
			if (e.aoColumns.push(r), e.aoPreSearchCols[l] === t || null === e.aoPreSearchCols[l]) e.aoPreSearchCols[l] = n.extend({},
			Ra.models.oSearch);
			else {
				var u = e.aoPreSearchCols[l];
				u.bRegex === t && (u.bRegex = !0),
				u.bSmart === t && (u.bSmart = !0),
				u.bCaseInsensitive === t && (u.bCaseInsensitive = !0)
			}
			i(e, l, null)
		}
		function i(e, a, s) {
			...
			l.fnSetData = x(l.mData),
			e.oFeatures.bSort || (l.bSortable = !1),
			!l.bSortable || -1 == n.inArray("asc", l.asSorting) && -1 == n.inArray("desc", l.asSorting) ? (l.sSortingClass = e.oClasses.sSortableNone, l.sSortingClassJUI = "") : -1 != n.inArray("asc", l.asSorting) && -1 != n.inArray("desc", l.asSorting) ? (l.sSortingClass = e.oClasses.sSortable, l.sSortingClassJUI = e.oClasses.sSortJUI) : -1 != n.inArray("asc", l.asSorting) && -1 == n.inArray("desc", l.asSorting) ? (l.sSortingClass = e.oClasses.sSortableAsc, l.sSortingClassJUI = e.oClasses.sSortJUIAscAllowed) : -1 == n.inArray("asc", l.asSorting) && -1 != n.inArray("desc", l.asSorting) && (l.sSortingClass = e.oClasses.sSortableDesc, l.sSortingClassJUI = e.oClasses.sSortJUIDescAllowed)
		}
		function u(e) {
			if (e.oFeatures.bAutoWidth === !1) return ! 1;
			fa(e);
			for (var a = 0,
			t = e.aoColumns.length; t > a; a++) e.aoColumns[a].nTh.style.width = e.aoColumns[a].sWidth
		}
		function d(e, a) {
			var t = h(e, "bVisible");
		...
		function g(e) {
			for (var a = "",
			t = 0,
			n = e.aoColumns.length; n > t; t++) a += e.aoColumns[t].sName + ",";
		...
		function b(e, a, t, s) {
			...
			if (a) for (o = a.length - 1; o >= 0; o--) {
				...
				else if ("string" == typeof f[i]) for (d = 0, c = e.aoColumns.length; c > d; d++)("_all" == f[i] || n(e.aoColumns[d].nTh).hasClass(f[i])) && s(d, a[o])
			}
		...
		function S(e, a, t, s) {
			...
			e.aoData.push(r);
			for (var i, u = 0,
			d = e.aoColumns.length; d > u; u++) if (o = e.aoColumns[u], T(e, l, u, v(e, l, u)), o._bAutoType && "string" != o.sType) {
				var c = v(e, l, u, "type");
				null !== c && "" !== c && (i = p(c), null === o.sType ? o.sType = i: o.sType != i && "html" != o.sType && (o.sType = "string"))
			}
			return e.aiDisplayMaster.push(l),
			e.oFeatures.bDeferRender || A(e, l, t, s),
			l
		}
		function C(e, a) { ! a instanceof n && (a = n(a)),
			a.each(function() {
				for (var a, t = [], s = [], o = this.firstChild; o;) a = o.nodeName.toUpperCase(),
				("TD" == a || "TH" == a) && (t.push(n.trim(o.innerHTML)), s.push(o)),
				o = o.nextSibling;
				S(e, t, this, s)
			})
		}
		...
		function v(e, a, n, s) {
			...
			l = e.aoData[a]._aData,
			r = o.fnGetData(l, s);
			if (r === t) return e.iDrawError != e.iDraw && null === o.sDefaultContent && (Ia(e, 0, "Requested unknown parameter " + ("function" == typeof o.mData ? "{mData function}": "'" + o.mData + "'") + " from the data source for row " + a), e.iDrawError = e.iDraw),
			o.sDefaultContent;
			...
			var a = function(e, n, s) {
				...
				d = i.length; d > u; u++) {
					if (o = i[u].match(Ea)) {
						...
						r = i.join(".");
						for (var c = 0,
						f = e.length; f > c; c++) l.push(a(e[c], n, r));
		...
		function F(e, a) {
			for (var t = -1,
			n = 0,
			s = e.length; s > n; n++) e[n] == a ? t = n: e[n] > a && e[n]--; - 1 != t && e.splice(t, 1)
		}
		function A(e, t, n, s) {
			var o, l, r, i, u, d = e.aoData[t],
			c = d._aData;
			if (null === d.nTr) {
				for (o = n || a.createElement("tr"), o._DT_RowIndex = t, c.DT_RowId && (o.id = c.DT_RowId), c.DT_RowClass && (o.className += " " + c.DT_RowClass), i = 0, u = e.aoColumns.length; u > i; i++) r = e.aoColumns[i],
				l = n ? s[i] : a.createElement(r.sCellType),
				(!n || r.mRender || r.mData !== i) && (l.innerHTML = v(e, t, i, "display")),
				null !== r.sClass && (l.className += " " + r.sClass),
				d._anHidden[i] = r.bVisible ? null: l,
				r.bVisible && !n ? o.appendChild(l) : !r.bVisible && n && l.parentNode.removeChild(l),
				r.fnCreatedCell && r.fnCreatedCell.call(e.oInstance, l, v(e, t, i, "display"), c, t, i);
				d.nTr = o,
				La(e, "aoRowCreatedCallback", null, [o, c, t])
			}
		}
		function P(e) {
			var t, s, o, l = n("th, td", e.nTHead).length;
			if (0 !== l) for (t = 0, o = e.aoColumns.length; o > t; t++) s = e.aoColumns[t].nTh,
			s.setAttribute("role", "columnheader"),
			e.aoColumns[t].bSortable && (s.setAttribute("tabindex", e.iTabIndex), s.setAttribute("aria-controls", e.sTableId)),
			null !== e.aoColumns[t].sClass && n(s).addClass(e.aoColumns[t].sClass),
			e.aoColumns[t].sTitle != s.innerHTML && (s.innerHTML = e.aoColumns[t].sTitle);
			else {
				var r = a.createElement("tr");
				for (t = 0, o = e.aoColumns.length; o > t; t++) s = e.aoColumns[t].nTh,
				s.innerHTML = e.aoColumns[t].sTitle,
				s.setAttribute("tabindex", "0"),
				null !== e.aoColumns[t].sClass && n(s).addClass(e.aoColumns[t].sClass),
				r.appendChild(s);
				n(e.nTHead).html("")[0].appendChild(r),
				H(e.aoHeader, e.nTHead)
			}
			if (n(e.nTHead).children("tr").attr("role", "row"), e.bJUI) for (t = 0, o = e.aoColumns.length; o > t; t++) {
				...
				n(s).contents().appendTo(i);
				var u = a.createElement("span");
				u.className = e.oClasses.sSortIcon,
				i.appendChild(u),
				s.appendChild(i)
			}
		...
		function L(e, a, n) {
			...
			for (s = 0, o = h.length; o > s; s++) {
				...
				for (l = 0, r = h[s].length; r > l; l++) if (c = 1, f = 1, p[s][l] === t) {
					for (d.appendChild(h[s][l].cell), p[s][l] = 1; h[s + c] !== t && h[s][l].cell == h[s + c][l].cell;) p[s + c][l] = 1,
					c++;
					for (; h[s][l + f] !== t && h[s][l].cell == h[s][l + f].cell;) {
						for (i = 0; c > i; i++) p[s + i][l + f] = 1;
						f++
					}
					h[s][l].cell.rowSpan = c,
					h[s][l].cell.colSpan = f
				}
			}
		}
		function N(e) {
			...
			if (e.bDrawing = !0, e.iInitDisplayStart !== t && -1 != e.iInitDisplayStart && (e._iDisplayStart = e.oFeatures.bServerSide ? e.iInitDisplayStart: e.iInitDisplayStart >= e.fnRecordsDisplay() ? 0 : e.iInitDisplayStart, e.iInitDisplayStart = -1, na(e)), e.bDeferLoading) e.bDeferLoading = !1,
			e.iDraw++;
			...
			if (0 !== e.aiDisplay.length) {
				...
				for (var g = h; p > g; g++) {
					...
					La(e, "aoRowCallback", null, [S, e.aoData[e.aiDisplay[g]]._aData, u, g]),
					i.push(S),
					u++;
				...
				i[0] = a.createElement("tr"),
				e.asStripeClasses[0] && (i[0].className = e.asStripeClasses[0]);
				var m = e.oLanguage,
				y = m.sZeroRecords;
				...
				v.colSpan = f(e),
				v.className = e.oClasses.sRowEmpty,
				v.innerHTML = K(e, y),
				i[u].appendChild(v)
			}
			La(e, "aoHeaderCallback", "header", [n(e.nTHead).children("tr")[0], I(e), e._iDisplayStart, e.fnDisplayEnd(), e.aiDisplay]),
			La(e, "aoFooterCallback", "footer", [n(e.nTFoot).children("tr")[0], I(e), e._iDisplayStart, e.fnDisplayEnd(), e.aiDisplay]);
			...
			if (e.nTBody) {
				...
				e.nTBody.appendChild(_),
				null !== T && T.appendChild(e.nTBody)
			}
			La(e, "aoDrawCallback", "draw", [e]),
			e.bSorted = !1,
			e.bFiltered = !1,
			e.bDrawing = !1,
			e.oFeatures.bServerSide && (ra(e, !1), e._bInitComplete || aa(e))
		}
		function R(e) {
		...
		function E(e) {
			var a = n("<div></div>")[0];
			e.nTable.parentNode.insertBefore(a, e.nTable),
			e.nTableWrapper = n('<div id="' + e.sTableId + '_wrapper" class="' + e.oClasses.sWrapper + '" role="grid"></div>')[0],
			e.nTableReinsertBefore = e.nTable.nextSibling;
			for (var t, s, o, l, r, i, u, d = e.nTableWrapper,
			c = e.sDom.split(""), f = 0; f < c.length; f++) {
				if (s = 0, o = c[f], "<" == o) {
					if (l = n("<div></div>")[0], r = c[f + 1], "'" == r || '"' == r) {
						for (i = "", u = 2; c[f + u] != r;) i += c[f + u],
						u++;
						if ("H" == i ? i = e.oClasses.sJUIHeader: "F" == i && (i = e.oClasses.sJUIFooter), -1 != i.indexOf(".")) {
							var h = i.split(".");
							l.id = h[0].substr(1, h[0].length - 1),
							l.className = h[1]
				...
				else if ("l" == o && e.oFeatures.bPaginate && e.oFeatures.bLengthChange) t = ta(e),
				s = 1;
				else if ("f" == o && e.oFeatures.bFilter) t = J(e),
				s = 1;
				else if ("r" == o && e.oFeatures.bProcessing) t = la(e),
				s = 1;
				else if ("t" == o) t = ia(e),
				s = 1;
				else if ("i" == o && e.oFeatures.bInfo) t = z(e),
				s = 1;
				else if ("p" == o && e.oFeatures.bPaginate) t = sa(e),
				s = 1;
				else if (0 !== Ra.ext.aoFeatures.length) for (var p = Ra.ext.aoFeatures,
				g = 0,
				b = p.length; b > g; g++) if (o == p[g].cFeature) {
					t = p[g].fnInit(e),
					t && (s = 1);
					break
				}
		...
		function B(e, a, t) {
			...
			for (var s = 0,
			o = t.length; o > s; s++) for (var l = 0,
			r = t[s].length; r > l; l++) ! t[s][l].unique || n[l] && e.bSortCellsTop || (n[l] = t[s][l].cell);
			return n
		}
		function W(e) {
			if (e.bAjaxDataGet) {
				...
				return k(e, a),
				e.fnServerData.call(e.oInstance, e.sAjaxSource, a,
				function(a) {
					M(e, a)
				},
				e),
		...
		function U(e) {
			...
			}), s = 0; l > s; s++) a = e.aoColumns[s].mData,
			r.push({
				name: "mDataProp_" + s,
		...
		function M(e, a) {
			if (a.sEcho !== t) {
				...
				e.iDraw = 1 * a.sEcho
			} (!e.oScroll.bInfinite || e.bSorted || e.bFiltered) && w(e),
			e._iRecordsTotal = parseInt(a.iTotalRecords, 10),
			e._iRecordsDisplay = parseInt(a.iTotalDisplayRecords, 10);
		...
		function J(e) {
			...
			o.className = e.oClasses.sFilter,
			o.innerHTML = "<label>" + s + "</label>",
			e.aanFeatures.f || (o.id = e.sTableId + "_filter");
			var l = n('input[type="text"]', o);
			return o._DT_Input = l[0],
			l.val(t.sSearch.replace('"', "&quot;")),
			l.bind("keyup.DT",
			function() {
				for (var a = e.aanFeatures.f,
				s = "" === this.value ? "": this.value, o = 0, l = a.length; l > o; o++) a[o] != n(this).parents("div.dataTables_filter")[0] && n(a[o]._DT_Input).val(s);
				s != t.sSearch && O(e, {
					sSearch: s,
					bRegex: t.bRegex,
					bSmart: t.bSmart,
			...
			l.attr("aria-controls", e.sTableId).bind("keypress.DT",
			function(e) {
		...
		function j(e) {
			for (var a = Ra.ext.afnFiltering,
			t = h(e, "bSearchable"), n = 0, s = a.length; s > n; n++) for (var o = 0,
			l = 0,
			r = e.aiDisplay.length; r > l; l++) {
		...
		function V(e, a, t, n, s, o) {
			if ("" !== a) for (var l = 0,
			r = q(a, n, s, o), i = e.aiDisplay.length - 1; i >= 0; i--) {
		...
		function X(e, a, t, n, s, o) {
			var l, r = q(a, n, s, o),
			i = e.oPreviousSearch;
			if (t || (t = 0), 0 !== Ra.ext.afnFiltering.length && (t = 1), a.length <= 0) e.aiDisplay.splice(0, e.aiDisplay.length),
			e.aiDisplay = e.aiDisplayMaster.slice();
			else if (e.aiDisplay.length == e.aiDisplayMaster.length || i.sSearch.length > a.length || 1 == t || 0 !== a.indexOf(i.sSearch)) for (e.aiDisplay.splice(0, e.aiDisplay.length), G(e, 1), l = 0; l < e.aiDisplayMaster.length; l++) r.test(e.asDataSearch[l]) && e.aiDisplay.push(e.aiDisplayMaster[l]);
			else {
				var u = 0;
		...
		function Y(e, a) {
			for (var t = 0,
			s = a.length; s > t; t++) a[t] = Z(a[t], e.aoColumns[t].sType);
			var o = a.join("  ");
			return - 1 !== o.indexOf("&") && (o = n("<div>").html(o).text()),
			o.replace(/[\n\r]/g, " ")
		}
		function q(e, a, t, n) {
			var s, o = a ? e: Q(e);
			return t && (s = o.split(" "), o = "^(?=.*?" + s.join(")(?=.*?") + ").*$"),
			new RegExp(o, n ? "i": "")
		}
		function Z(e, a) {
		...
		function z(e) {
			...
			return t.className = e.oClasses.sInfo,
		...
		function $(e) {
			if (e.oFeatures.bInfo && 0 !== e.aanFeatures.i.length) {
				...
				a = 0 === r ? t.sInfoEmpty: t.sInfo,
				r != l && (a += " " + t.sInfoFiltered),
				a += t.sInfoPostFix,
				a = K(e, a),
				null !== t.fnInfoCallback && (a = t.fnInfoCallback.call(e.oInstance, e, s, o, l, r, a));
				for (var i = e.aanFeatures.i,
				u = 0,
				d = i.length; d > u; u++) n(i[u]).html(a)
			}
		}
		function K(e, a) {
		...
		function ea(e) {
			...
			if (e.oFeatures.bSort ? Ca(e) : e.oFeatures.bFilter ? O(e, e.oPreviousSearch) : (e.aiDisplay = e.aiDisplayMaster.slice(), na(e), N(e)), null !== e.sAjaxSource && !e.oFeatures.bServerSide) {
				var s = [];
				return k(e, s),
				void e.fnServerData.call(e.oInstance, e.sAjaxSource, s,
				function(t) {
					var s = "" !== e.sAjaxDataProp ? _(e.sAjaxDataProp)(t) : t;
					for (a = 0; a < s.length; a++) S(e, s[a]);
					e.iInitDisplayStart = n,
					e.oFeatures.bSort ? Ca(e) : (e.aiDisplay = e.aiDisplayMaster.slice(), na(e), N(e)),
					ra(e, !1),
					aa(e, t)
				},
				e)
		...
		function ta(e) {
			...
			l = '<select size="1" ' + o + ">",
			r = e.aLengthMenu;
			if (2 == r.length && "object" == typeof r[0] && "object" == typeof r[1]) for (t = 0, s = r[0].length; s > t; t++) l += '<option value="' + r[0][t] + '">' + r[1][t] + "</option>";
			else for (t = 0, s = r.length; s > t; t++) l += '<option value="' + r[t] + '">' + r[t] + "</option>";
			l += "</select>";
			var i = a.createElement("div");
			return e.aanFeatures.l || (i.id = e.sTableId + "_length"),
			i.className = e.oClasses.sLength,
			i.innerHTML = "<label>" + e.oLanguage.sLengthMenu.replace("_MENU_", l) + "</label>",
			n('select option[value="' + e._iDisplayLength + '"]', i).attr("selected", !0),
			n("select", i).bind("change.DT",
			function() {
				var a = n(this).val(),
				o = e.aanFeatures.l;
				for (t = 0, s = o.length; s > t; t++) o[t] != this.parentNode && n("select", o[t]).val(a);
				e._iDisplayLength = parseInt(a, 10),
				na(e),
				e.fnDisplayEnd() == e.fnRecordsDisplay() && (e._iDisplayStart = e.fnDisplayEnd() - e._iDisplayLength, e._iDisplayStart < 0 && (e._iDisplayStart = 0)),
				-1 == e._iDisplayLength && (e._iDisplayStart = 0),
				N(e)
			}),
			n("select", i).attr("aria-controls", e.sTableId),
			i
		}
		function na(e) {
		...
		function sa(e) {
			if (e.oScroll.bInfinite) return null;
			var t = a.createElement("div");
			return t.className = e.oClasses.sPaging + e.sPaginationType,
			Ra.ext.oPagination[e.sPaginationType].fnInit(e, t,
			function(e) {
				na(e),
				N(e)
			}),
			e.aanFeatures.p || e.aoDrawCallback.push({
				fn: function(e) {
					Ra.ext.oPagination[e.sPaginationType].fnUpdate(e,
					function(e) {
						na(e),
						N(e)
					})
		...
		function oa(e, a) {
			...
			if ("number" == typeof a) e._iDisplayStart = a * e._iDisplayLength,
			e._iDisplayStart > e.fnRecordsDisplay() && (e._iDisplayStart = 0);
			else if ("first" == a) e._iDisplayStart = 0;
			else if ("previous" == a) e._iDisplayStart = e._iDisplayLength >= 0 ? e._iDisplayStart - e._iDisplayLength: 0,
			...
			else if ("last" == a) if (e._iDisplayLength >= 0) {
			...
			return n(e.oInstance).trigger("page", e),
			t != e._iDisplayStart
		}
		function la(e) {
			var t = a.createElement("div");
			return e.aanFeatures.r || (t.id = e.sTableId + "_processing"),
		...
		function ra(e, a) {
			if (e.oFeatures.bProcessing) for (var t = e.aanFeatures.r,
			s = 0,
			o = t.length; o > s; s++) t[s].style.visibility = a ? "visible": "hidden";
		...
		function ia(e) {
			...
			s.appendChild(o),
			r.appendChild(i),
			l.appendChild(e.nTable),
			t.appendChild(s),
			t.appendChild(l),
			o.appendChild(u),
			u.appendChild(c),
			null !== f && (t.appendChild(r), i.appendChild(d), d.appendChild(f)),
			t.className = h.sScrollWrapper,
			s.className = h.sScrollHead,
			o.className = h.sScrollHeadInner,
			l.className = h.sScrollBody,
			r.className = h.sScrollFoot,
			i.className = h.sScrollFootInner,
			e.oScroll.bAutoCss && (s.style.overflow = "hidden", s.style.position = "relative", r.style.overflow = "hidden", l.style.overflow = "auto"),
			s.style.border = "0",
			s.style.width = "100%",
			r.style.border = "0",
			o.style.width = "" !== e.oScroll.sXInner ? e.oScroll.sXInner: "100%",
			...
			return p.length > 0 && (p = p[0], "top" === p._captionSide ? u.appendChild(p) : "bottom" === p._captionSide && f && d.appendChild(p)),
			"" !== e.oScroll.sX && (s.style.width = ba(e.oScroll.sX), l.style.width = ba(e.oScroll.sX), null !== f && (r.style.width = ba(e.oScroll.sX)), n(l).scroll(function() {
				s.scrollLeft = this.scrollLeft,
				null !== f && (r.scrollLeft = this.scrollLeft)
			})),
			"" !== e.oScroll.sY && (l.style.height = ba(e.oScroll.sY)),
		...
		function ua(e) {
			...
			n(e.nTable).children("thead, tfoot").remove(),
			c = n(e.nTHead).clone()[0],
			e.nTable.insertBefore(c, e.nTable.childNodes[0]),
			s = e.nTHead.getElementsByTagName("tr"),
			o = c.getElementsByTagName("tr"),
			null !== e.nTFoot && (f = n(e.nTFoot).clone()[0], e.nTable.insertBefore(f, e.nTable.childNodes[1]), r = e.nTFoot.getElementsByTagName("tr"), l = f.getElementsByTagName("tr")),
			"" === e.oScroll.sX && (b.style.width = "100%", p.parentNode.style.width = "100%");
			var T = B(e, c);
			for (a = 0, t = T.length; t > a; a++) u = d(e, a),
			T[a].style.width = e.aoColumns[u].sWidth;
			...
			l), n(e.nTable).outerWidth() < h) {
				...
				y && (b.scrollHeight > b.offsetHeight || "scroll" == n(b).css("overflow-y")) && (e.nTable.style.width = ba(_ - e.oScroll.iBarWidth)),
				b.style.width = ba(_),
				e.nScrollHead.style.width = ba(_),
				null !== e.nTFoot && (e.nScrollFoot.style.width = ba(_)),
				"" === e.oScroll.sX ? Ia(e, 1, "The table cannot fit into the current element which will cause column misalignment. The table has been drawn at its minimum possible width.") : "" !== e.oScroll.sXInner && Ia(e, 1, "The table cannot fit into the current element which will cause column misalignment. Increase the sScrollXInner value or remove it to allow automatic calculation")
			} else b.style.width = ba("100%"),
			...
			p.style.paddingRight = w ? e.oScroll.iBarWidth + "px": "0px",
			null !== e.nTFoot && (m.style.width = ba(I), D.style.width = ba(I), D.style.paddingRight = w ? e.oScroll.iBarWidth + "px": "0px"),
			n(b).scroll(),
			(e.bSorted || e.bFiltered) && (b.scrollTop = 0)
		}
		function da(e, a, t) {
			for (var n, s, o = 0,
			l = 0,
			r = a.length; r > l;) {
				for (n = a[l].firstChild, s = t ? t[l].firstChild: null; n;) 1 === n.nodeType && (t ? e(n, s, o) : e(n, o), o++),
				n = n.nextSibling,
				s = t ? s.nextSibling: null;
				l++
			}
		}
		function ca(e, t) {
		...
		function fa(e) {
			...
			if (u == d.length && 0 === r && i == u && "" === e.oScroll.sX && "" === e.oScroll.sY) for (s = 0; s < e.aoColumns.length; s++) t = n(d[s]).width(),
			null !== t && (e.aoColumns[s].sWidth = ba(t));
			else {
				...
				h.appendChild(p),
				null !== e.nTFoot && (h.appendChild(e.nTFoot.cloneNode(!0)), da(function(e) {
					e.style.width = ""
				},
				h.getElementsByTagName("tr"))),
				h.appendChild(g),
				g.appendChild(b);
				var S = n("thead th", h);
				...
				f.appendChild(h),
				"" !== e.oScroll.sX && "" !== e.oScroll.sXInner ? h.style.width = ba(e.oScroll.sXInner) : "" !== e.oScroll.sX ? (h.style.width = "", n(h).width() < f.offsetWidth && (h.style.width = ba(f.offsetWidth))) : "" !== e.oScroll.sY ? h.style.width = ba(f.offsetWidth) : c && (h.style.width = ba(c)),
		...
		function Ca(e, a) {
			...
			for (s = 0; s < F.length; s++) for (p = x[F[s][0]].aDataSort, i = 0, u = p.length; u > i; i++) b = p[i],
			S = x[b].sType || "string",
			h = y[S + "-pre"],
			D.push({
				col: b,
			...
			if (!e.oFeatures.bServerSide && 0 !== D.length) {
				for (s = 0; s < D.length; s++) {
					...
					if (d = e.aoColumns[A].sSortDataType, Ra.ext.afnSortData[d]) {
						...
						if (L.length === _.length) for (l = 0, r = _.length; r > l; l++) T(e, l, A, L[l]);
				...
				for (l = 0; l < D.length; l++) for (C = D[l], s = 0, o = _.length; o > s; s++) g = v(e, s, C.col, "sort"),
				_[s]._aSortData[C.col] = C.format ? C.format(g) : g;
				e.aiDisplayMaster.sort(w === D.length ?
				function(e, a) {
			...
			e.bSorted = !0,
			n(e.oInstance).trigger("sort", e),
			e.oFeatures.bFilter ? O(e, e.oPreviousSearch, 1) : (e.aiDisplay = e.aiDisplayMaster.slice(), e._iDisplayStart = 0, na(e), N(e))
		}
		function Da(e, a, t, n) {
			Aa(a, {},
			function(a) {
				if (e.aoColumns[t].bSortable !== !1) {
					var s = function() {
						...
						if (a.shiftKey) {
							for (var o = !1,
							l = 0; l < e.aaSorting.length; l++) if (e.aaSorting[l][0] == t) {
								o = !0,
								n = e.aaSorting[l][0],
								s = e.aaSorting[l][2] + 1,
								e.aoColumns[n].asSorting[s] ? (e.aaSorting[l][1] = e.aoColumns[n].asSorting[s], e.aaSorting[l][2] = s) : e.aaSorting.splice(l, 1);
								break
							}
					...
					e.oFeatures.bProcessing ? (ra(e, !0), setTimeout(function() {
						s(),
						e.oFeatures.bServerSide || ra(e, !1)
					},
					0)) : s(),
		...
		function ma(e) {
			...
			for (l = null !== e.aaSortingFixed ? e.aaSortingFixed.concat(e.aaSorting) : e.aaSorting.slice(), a = 0; a < e.aoColumns.length; a++) if (e.aoColumns[a].bSortable) {
				for (r = e.aoColumns[a].sSortingClass, o = -1, s = 0; s < l.length; s++) if (l[s][0] == a) {
					r = "asc" == l[s][1] ? u.sSortAsc: u.sSortDesc,
					o = s;
					break
				}
				if (n(e.aoColumns[a].nTh).addClass(r), e.bJUI) {
					...
					var c;
					c = -1 == o ? e.aoColumns[a].sSortingClassJUI: "asc" == l[o][1] ? u.sSortJUIAsc: u.sSortJUIDesc,
					d.addClass(c)
				}
			...
			if (r = u.sSortColumn, e.oFeatures.bSort && e.oFeatures.bSortClasses) {
				...
				for (a = 0, f = 1; a < l.length; a++) h = parseInt(l[a][0], 10),
				g[h] = r + f,
				3 > f && f++;
				var b, S, C, D = new RegExp(r + "[123]");
				for (a = 0, t = p.length; t > a; a++) h = a % i,
				S = p[a].className,
				C = g[h],
				b = S.replace(D, C),
				b != S ? p[a].className = n.trim(b) : C.length > 0 && -1 == S.indexOf(C) && (p[a].className = S + " " + C)
			}
		}
		function ya(e) {
			if (e.oFeatures.bStateSave && !e.bDestroying) {
				...
				La(e, "aoStateSaveParams", "stateSaveParams", [e, o]),
				e.fnStateSaveCallback.call(e.oInstance, e, o)
			}
		}
		function va(e, a) {
			if (e.oFeatures.bStateSave) {
				...
				if (t) {
					...
					if ( - 1 === n.inArray(!1, s) && !(t.iCreate < (new Date).getTime() - 1e3 * e.iStateDuration)) {
						...
						t),
						e._iDisplayStart = t.iStart,
						e.iInitDisplayStart = t.iStart,
						e._iDisplayEnd = t.iEnd,
						e._iDisplayLength = t.iLength,
						e.aaSorting = t.aaSorting.slice(),
						e.saved_aaSorting = t.aaSorting.slice(),
						n.extend(e.oPreviousSearch, t.oSearch),
						n.extend(!0, e.aoPreSearchCols, t.aoSearchCols),
						a.saved_aoColumns = [];
						for (var o = 0; o < t.abVisCols.length; o++) a.saved_aoColumns[o] = {},
						a.saved_aoColumns[o].bVisible = t.abVisCols[o];
		...
		function xa(e, a) {
			...
			for (a !== t && (h = a, p = a + 1), l = h; p > l; l++) if (u = e.aoData[l], null !== u.nTr) {
				for (s = [], o = u.nTr.firstChild; o;) d = o.nodeName.toLowerCase(),
				("td" == d || "th" == d) && s.push(o),
				o = o.nextSibling;
		...
		function La(e, a, t, s) {
			...
			return null !== t && n(e.oInstance).trigger(t, s),
			l
		}
		function Na(e) {
			...
			e.oBrowser.bScrollOversize = 100 === n("#DT_BrowserTest", t)[0].offsetWidth ? !0 : !1,
		...
		Ra = function(e) {
			...
			this.$ = function(e, a) {
				...
				a), "current" == a.page) for (t = r._iDisplayStart, s = r.fnDisplayEnd(); s > t; t++) o = i[u[t]].nTr,
				o && l.push(o);
				else if ("current" == a.order && "none" == a.filter) for (t = 0, s = d.length; s > t; t++) o = i[d[t]].nTr,
				o && l.push(o);
				else if ("current" == a.order && "applied" == a.filter) for (t = 0, s = u.length; s > t; t++) o = i[u[t]].nTr,
				o && l.push(o);
				else if ("original" == a.order && "none" == a.filter) for (t = 0, s = i.length; s > t; t++) o = i[t].nTr,
				o && l.push(o);
				else if ("original" == a.order && "applied" == a.filter) for (t = 0, s = i.length; s > t; t++) o = i[t].nTr,
				-1 !== n.inArray(t, u) && o && l.push(o);
			...
			this.fnAddData = function(e, a) {
				...
				return o.aiDisplay = o.aiDisplayMaster.slice(),
				(a === t || a) && R(o),
				s
			},
			this.fnAdjustColumnSizing = function(e) {
				...
				u(a),
				e === t || e ? this.fnDraw(!1) : ("" !== a.oScroll.sX || "" !== a.oScroll.sY) && this.oApi._fnScrollDraw(a)
			},
			...
			this.fnClose = function(e) {
				for (var a = Ta(this[Ra.ext.iApiIndex]), t = 0; t < a.aoOpenRows.length; t++) if (a.aoOpenRows[t].nParent == e) {
					...
					return n && n.removeChild(a.aoOpenRows[t].nTr),
					a.aoOpenRows.splice(t, 1),
					0
				}
				return 1
			},
			this.fnDeleteRow = function(e, a, s) {
				...
				return i.asDataSearch.splice(d, 1),
				F(i.aiDisplayMaster, r),
				F(i.aiDisplay, r),
				"function" == typeof a && a.call(this, i, u),
				i._iDisplayStart >= i.fnRecordsDisplay() && (i._iDisplayStart -= i._iDisplayLength, i._iDisplayStart < 0 && (i._iDisplayStart = 0)),
				(s === t || s) && (na(i), N(i)),
				u
			},
			...
			this.fnFilter = function(e, s, o, l, r, i) {
				...
				if (u.oFeatures.bFilter) if ((o === t || null === o) && (o = !1), (l === t || null === l) && (l = !0), (r === t || null === r) && (r = !0), (i === t || null === i) && (i = !0), s === t || null === s) {
					...
					1), r && u.aanFeatures.f) for (var d = u.aanFeatures.f,
					c = 0,
					f = d.length; f > c; c++) try {
			...
			this.fnOpen = function(e, t, s) {
				...
				if ( - 1 !== n.inArray(e, l)) {
					...
					i.className = s,
					i.colSpan = f(o),
					"string" == typeof t ? i.innerHTML = t: n(i).html(t);
					var u = n("tr", o.nTBody);
					return - 1 != n.inArray(e, u) && n(r).insertAfter(e),
					o.aoOpenRows.push({
						nTr: r,
						nParent: e
					}),
			...
			this.fnSetColumnVis = function(e, a, n) {
				...
				if (c[e].bVisible != a) {
					...
					for (c[e].bVisible = a, L(d, d.aoHeader), d.nTFoot && L(d, d.aoFooter), s = 0, o = d.aoOpenRows.length; o > s; s++) d.aoOpenRows[s].nTr.colSpan = f(d); (n === t || n) && (u(d), N(d)),
					ya(d)
				}
			},
			...
			this.fnUpdate = function(e, a, s, o, l) {
				...
				if (s === t || null === s) for (d.aoData[c]._aData = e, r = 0; r < d.aoColumns.length; r++) this.fnUpdate(v(d, c, r), c, r, !1, !1);
				else {
					T(d, c, s, e),
					i = v(d, c, s, "display"); {
						d.aoColumns[s]
				...
				return d.asDataSearch[f] = Y(d, y(d, c, "filter", h(d, "bSearchable"))),
				(l === t || l) && u(d),
				(o === t || o) && R(d),
				0
			},
			this.fnVersionCheck = Ra.ext.fnVersionCheck,
			this.oApi = {
				_fnExternApiFunc: Ea,
				_fnInitialise: ea,
				_fnInitComplete: aa,
			...
			return this.each(function() {
				...
				if (Ra.settings.push(D), D.oInstance = 1 === Ba.length ? Ba: n(this).dataTable(), e.oLanguage && l(e.oLanguage), e = Fa(n.extend(!0, {},
				Ra.defaults), e), wa(D.oFeatures, e, "bPaginate"), wa(D.oFeatures, e, "bLengthChange"), wa(D.oFeatures, e, "bFilter"), wa(D.oFeatures, e, "bSort"), wa(D.oFeatures, e, "bInfo"), wa(D.oFeatures, e, "bProcessing"), wa(D.oFeatures, e, "bAutoWidth"), wa(D.oFeatures, e, "bSortClasses"), wa(D.oFeatures, e, "bServerSide"), wa(D.oFeatures, e, "bDeferRender"), wa(D.oScroll, e, "sScrollX", "sX"), wa(D.oScroll, e, "sScrollXInner", "sXInner"), wa(D.oScroll, e, "sScrollY", "sY"), wa(D.oScroll, e, "bScrollCollapse", "bCollapse"), wa(D.oScroll, e, "bScrollInfinite", "bInfinite"), wa(D.oScroll, e, "iScrollLoadGap", "iLoadGap"), wa(D.oScroll, e, "bScrollAutoCss", "bAutoCss"), wa(D, e, "asStripeClasses"), wa(D, e, "fnServerData"), wa(D, e, "fnFormatNumber"), wa(D, e, "sServerMethod"), wa(D, e, "aaSorting"), wa(D, e, "aaSortingFixed"), wa(D, e, "aLengthMenu"), wa(D, e, "sPaginationType"), wa(D, e, "sAjaxSource"), wa(D, e, "sAjaxDataProp"), wa(D, e, "iCookieDuration", "iStateDuration"), wa(D, e, "iStateDuration"), wa(D, e, "sDom"), wa(D, e, "bSortCellsTop"), wa(D, e, "iTabIndex"), wa(D, e, "oSearch", "oPreviousSearch"), wa(D, e, "aoSearchCols", "aoPreSearchCols"), wa(D, e, "iDisplayLength", "_iDisplayLength"), wa(D, e, "bJQueryUI", "bJUI"), wa(D, e, "fnStateLoadCallback"), wa(D, e, "fnStateSaveCallback"), wa(D.oLanguage, e, "fnInfoCallback"), Pa(D, "aoDrawCallback", e.fnDrawCallback, "user"), Pa(D, "aoServerParams", e.fnServerParams, "user"), Pa(D, "aoStateSaveParams", e.fnStateSaveParams, "user"), Pa(D, "aoStateLoadParams", e.fnStateLoadParams, "user"), Pa(D, "aoStateLoaded", e.fnStateLoaded, "user"), Pa(D, "aoRowCallback", e.fnRowCallback, "user"), Pa(D, "aoRowCreatedCallback", e.fnCreatedRow, "user"), Pa(D, "aoHeaderCallback", e.fnHeaderCallback, "user"), Pa(D, "aoFooterCallback", e.fnFooterCallback, "user"), Pa(D, "aoInitComplete", e.fnInitComplete, "user"), Pa(D, "aoPreDrawCallback", e.fnPreDrawCallback, "user"), D.oFeatures.bServerSide && D.oFeatures.bSort && D.oFeatures.bSortClasses ? Pa(D, "aoDrawCallback", ma, "server_side_sort_classes") : D.oFeatures.bDeferRender && Pa(D, "aoDrawCallback", ma, "defer_sort_classes"), e.bJQueryUI ? (n.extend(D.oClasses, Ra.ext.oJUIClasses), e.sDom === Ra.defaults.sDom && "lfrtip" === Ra.defaults.sDom && (D.sDom = '<"H"lfr>t<"F"ip>')) : n.extend(D.oClasses, Ra.ext.oStdClasses), n(this).addClass(D.oClasses.sTable), ("" !== D.oScroll.sX || "" !== D.oScroll.sY) && (D.oScroll.iBarWidth = Sa()), D.iInitDisplayStart === t && (D.iInitDisplayStart = e.iDisplayStart, D._iDisplayStart = e.iDisplayStart), e.bStateSave && (D.oFeatures.bStateSave = !0, va(D, e), Pa(D, "aoDrawCallback", ya, "state_save")), null !== e.iDeferLoading) {
					...
					D._iRecordsDisplay = m ? e.iDeferLoading[0] : e.iDeferLoading,
					D._iRecordsTotal = m ? e.iDeferLoading[1] : e.iDeferLoading
				}
				null !== e.aaData && (p = !0),
				"" !== e.oLanguage.sUrl ? (D.oLanguage.sUrl = e.oLanguage.sUrl, n.getJSON(D.oLanguage.sUrl, null,
				function(a) {
					l(a),
					o(Ra.defaults.oLanguage, a),
					n.extend(!0, D.oLanguage, e.oLanguage, a),
					ea(D)
				}), h = !0) : n.extend(!0, D.oLanguage, e.oLanguage),
				null === e.asStripeClasses && (D.asStripeClasses = [D.oClasses.sStripeOdd, D.oClasses.sStripeEven]);
				var y = D.asStripeClasses; - 1 !== n.inArray(!0, n.map(y,
				function(e) {
				...
				if (0 !== _.length && (H(D.aoHeader, _[0]), T = B(D)), null === e.aoColumns) for (v = [], c = 0, s = T.length; s > c; c++) v.push(null);
				else v = e.aoColumns;
				for (c = 0, s = v.length; s > c; c++) e.saved_aoColumns !== t && e.saved_aoColumns.length == s && (null === v[c] && (v[c] = {}), v[c].bVisible = e.saved_aoColumns[c].bVisible),
				r(D, T ? T[c] : null);
				for (b(D, e.aoColumnDefs, v,
				function(e, a) {
					i(D, e, a)
				...
				0 === w.length && (w = [a.createElement("thead")], this.appendChild(w[0])),
				D.nTHead = w[0];
				var F = n(this).children("tbody");
				0 === F.length && (F = [a.createElement("tbody")], this.appendChild(F[0])),
				D.nTBody = F[0],
				D.nTBody.setAttribute("role", "alert"),
				D.nTBody.setAttribute("aria-live", "polite"),
				D.nTBody.setAttribute("aria-relevant", "all");
				var A = n(this).children("tfoot");
				if (0 === A.length && I.length > 0 && ("" !== D.oScroll.sX || "" !== D.oScroll.sY) && (A = [a.createElement("tfoot")], this.appendChild(A[0])), A.length > 0 && (D.nTFoot = A[0], H(D.aoFooter, D.nTFoot)), p) for (c = 0; c < e.aaData.length; c++) S(D, e.aaData[c]);
		...
		Ra.fnIsDataTable = function(e) {
			for (var a = Ra.settings,
			t = 0; t < a.length; t++) if (a[t].nTable === e || a[t].nScrollHead === e || a[t].nScrollFoot === e) return ! 0;
			return ! 1
		},
		Ra.fnTables = function(e) {
			var a = [];
			return jQuery.each(Ra.settings,
			function(t, s) { (!e || e === !0 && n(s.nTable).is(":visible")) && a.push(s.nTable)
			}),
			a
		},
		Ra.version = "1.10.0-dev",
		Ra.settings = [],
		Ra.models = {},
		Ra.models.ext = {
			afnFiltering: [],
		...
		Ra.defaults = {
			...
			fnFormatNumber: function(e) {
				if (1e3 > e) return e;
				for (var a = e + "",
				t = a.split(""), n = "", s = a.length, o = 0; s > o; o++) o % 3 === 0 && 0 !== o && (n = this.language.infoThousands + n),
				n = t[s - o - 1] + n;
				return n
			},
			...
			fnServerData: function(e, a, t, s) {
				s.jqXHR = n.ajax({
					...
					data: a,
					success: function(e) {
						e.sError && s.oApi._fnLog(s, 0, e.sError),
						n(s.oInstance).trigger("xhr", [s, e]),
						t(e)
					},
					dataType: "json",
					cache: !1,
			...
			oLanguage: {
				...
				sInfo: "第 _START_ 条至 _END_ 条 总条数:_TOTAL_ ",
				sInfoEmpty: "第 0 条至 0 条 总条数:0 ",
				sInfoFiltered: "(匹配记录)",
				sInfoPostFix: "",
				sInfoThousands: ",",
		...
		n.extend(Ra.ext.oPagination, {
			two_button: {
				fnInit: function(e, a, t) {
					...
					o),
					e.aanFeatures.p || (a.id = e.sTableId + "_paginate", i.id = e.sTableId + "_previous", u.id = e.sTableId + "_next", i.setAttribute("aria-controls", e.sTableId), u.setAttribute("aria-controls", e.sTableId))
				},
				fnUpdate: function(e) {
					if (e.aanFeatures.p) for (var a, t = e.oClasses,
					n = e.aanFeatures.p,
					s = 0,
					o = n.length; o > s; s++) a = n[s].firstChild,
					a && (a.className = 0 === e._iDisplayStart ? t.sPagePrevDisabled: t.sPagePrevEnabled, a = a.nextSibling, a.className = e.fnDisplayEnd() == e.fnRecordsDisplay() ? t.sPageNextDisabled: t.sPageNextEnabled)
				}
			},
			...
			full_numbers: {
				fnInit: function(e, a, t) {
					...
					l),
					e.oApi._fnBindAction(c, {
						action: "last"
					},
					l),
					e.aanFeatures.p || (a.id = e.sTableId + "_paginate", i.id = e.sTableId + "_first", u.id = e.sTableId + "_previous", d.id = e.sTableId + "_next", c.id = e.sTableId + "_last")
				},
				fnUpdate: function(e, a) {
					if (e.aanFeatures.p) {
						...
						S = function(n) {
							...
							function(t) {
								e.oApi._fnPageChange(e, t.data.page),
								a(e),
								t.preventDefault()
							})
						};
		...
		n.extend(Ra.ext.oSort, {
			...
			"date-pre": function(e) {
				var a = Date.parse(e);
				return (isNaN(a) || "" === a) && (a = Date.parse("01/01/1970 00:00:00")),
				a
			},
		...
		n.fn.DataTable = Ra,
		n.fn.dataTable = Ra,
		n.fn.dataTableSettings = Ra.settings,
		n.fn.dataTableExt = Ra.ext
	})
} (window, document);